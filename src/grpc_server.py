...
# This host and port are for react.
# This port must match the "proxy": "http://localhost:5000" in frontend/package.json
...
def get_data():
    ...
    # Here, you can implement your logic to get data using the query
    # For example, you can query your database or call a gRPC service
    if query == "test":
...
def get_user_data():
    ...
    for user in users:
        ...
        user_data.append({
            ...
            'tasks': user_dict.get('tasks', [])  # Asegura que 'tasks' esté presente
        })
